            ...
            <div class="p-5">
                <div>
                    ...
                    <p class="text-2xl font-bold text-teal-900 ml-5">
                        <span
                            ...
                            class="hover:text-teal-700">Student Management</span> / Grade Four
                    </p>
                </div>
                ...
                <section class="mx-auto p-6 mt-5 rounded-lg shadow-lg bg-gray-200">
                    <div class="w-full bg-white mb-8 overflow-hidden rounded-lg shadow-lg text-[12px]">
                        @if ($noGradeFourMessage)
                            <p class="text-red-600 text-center text-md">{{ $noGradeFourMessage }}</p>
                        @else
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#dropdownDefaultButton').click(function () {
                ...
                $.ajax({
                    url: '{{ route('get.foursections') }}', // The route for fetching sections
                    type: 'GET',
