            ...
            <div class="p-5">
                <div>
                    ...
                    <p class="text-2xl font-bold text-teal-900 ml-5">
                        <span
                            ...
                            class="hover:text-teal-700">Management Account</span> / Admin
                    </p>
                </div>
                ...
                <div id="addAdminModal"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="font-bold text-teal-900">Add Admin</p>
                        ...
                        <div class="mb-5 mt-5 bg-white p-3">
                            ...
                            <form action="{{ route('admin.create') }}" method="POST">
                                ...
                                <div class="mb-4 hidden">
                                    ...
                                    <input type="hidden" name="role" placeholder="Role.." value="Admin" id="role"
                                        required
                ...
                <section class="mx-auto p-6 mt-5 rounded-lg shadow-lg bg-gray-200 ">
                    <div class="w-full bg-white overflow-hidden rounded-lg shadow-lg text-[12px]">
                        @if ($noAdmin)
                            <p class="text-red-600 text-center text-md">{{ $noAdmin }}</p>
                        @else
                            <div class="p-5">
