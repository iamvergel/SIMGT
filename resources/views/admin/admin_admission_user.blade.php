            ...
            <div class="p-5">
                ...
                <div id="addAdminModal"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="font-bold text-teal-900">Add Admission</p>
                        ...
                        <div class="mb-5 mt-5 bg-white p-3">
                            ...
                            <form action="{{ route('admission.create') }}" method="POST">
                                ...
                                <div class="mb-4 hidden">
                                    ...
                                    <input type="hidden" name="role" placeholder="Role.." value="Admission" id="role"
                                        required
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="admission_number" placeholder="Input Employee ID.."
                ...
                <section class="mx-auto p-6 mt-5 rounded-lg shadow-lg bg-gray-200 ">
                    <div class="w-full bg-white overflow-hidden rounded-lg shadow-lg text-[12px]">
                        @if ($noAdmission)
                            <p class="text-red-600 text-center text-md">{{ $noAdmission }}</p>
                        @else
                            <div class="p-5">
                                    ...
                                    <tbody class="" id="tableBody">
                                        @foreach ($admin as $admins)
                                                <tr class=" hover:bg-gray-100">
                                                    <td>
                                                        <span class="ml-2">{{ $admins->admission_number }}</span>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('admission.delete', $admins->id) }}" method="POST"
