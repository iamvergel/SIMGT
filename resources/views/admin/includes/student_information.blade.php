                                        ...
                                        <div class="w-full h-full bg-white rounded-lg shadow p-5">
                                            ...
                                            <p class="text-2xl font-bold text-teal-900 ml-5">
                                                <span
                                                    ...
                                                    class="hover:text-teal-700">Student Management / </span>{{ $students->grade }} /
                                                {{ $students->student_last_name }}, {{ $students->student_first_name }}
                                                {{ $students->student_suffix_name }} {{ $students->student_middle_name }}
                                            </p>
                                            ...
                                            <div class="mt-5 text-[12px] w-full">
                                                <ul
                                                    ...
                                                    <li class="cursor-pointer text-white bg-teal-600 hover:bg-teal-700 transition-all duration-300 p-2 rounded-t-lg px-5 active1"
                                                        data-target="#Information">{{ $students->student_first_name }} Information</li>
                                                        ...
                                                        <div class="col-span-4 mt-10">
                                                            ...
                                                            <div class="">
                                                                <label for="modalProofOfResidency"
                                                                    class="block mb-2 text-[12px] font-bold text-gray-900">Form 137
                                                                    :</label>
