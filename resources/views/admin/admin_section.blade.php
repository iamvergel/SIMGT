...
<body class="font-poppins bg-gray-200 overflow-hidden">
            ...
            <div class="p-5">
                <div>
                    ...
                    <p class="text-2xl font-bold text-teal-900 ml-5">
                        <span
                            ...
                            class="hover:text-teal-700">Management System</span> / section
                    </p>
                </div>
                ...
                <div id="deletesectionModal"
                    ...
                    <div
                        ...
                        <div
                            ...
                            <p class="font-bold text-teal-900">Delete section</p>
                        ...
                        <div class="mb-5 mt-5 bg-white p-3">
                            ...
                            <form id="deletesectionForm" action="" method="POST" class="mt-8 flex justify-end gap-2">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                ...
                <div id="editsectionModal"
                    ...
                    <div
                        ...
                        <div
                            class="flex justify-between items-center p-2 px-4 py-5 mt-5 px-4 bg-white shadow-lg sticky top-0">
                            <p class="font-bold text-teal-900">Edit section</p>
                        ...
                        <div class="mb-5 mt-5 bg-white p-3">
                            ...
                            <form action="" id="editsectionForm" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="section" placeholder="Input Section Name.."
                ...
                <div id="addAdminModal"
                    ...
                    <div
                        ...
                        <div
                            class="flex justify-between items-center p-2 px-4  py-5 mt-5 px-4 bg-white shadow-lg  sticky top-0">
                            <p class="font-bold text-teal-900">Add section</p>
                        ...
                        <div class="mb-5 mt-5 bg-white p-3">
                            ...
                            <form action="{{ route('section.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="section" placeholder="Input Section Name.." id="section"
                                        required
                                        class="form-input block text-sm text-normal text-dark tracking-wider w-full lg:w-96 pl-5 p-3 border border-gray-400 rounded-md px-5">
                                </div>
                                <div class="flex justify-end">
                                ...
                                <tbody class="" id="tableBody">
                                    @foreach ($sections as $section)
                                        ...
                                        <tr class="hover:bg-gray-100">
                                            <td>
                                                <span class="ml-2">{{ $section->id }}</span>
                                            </td>
                                            <td>
                                                <span class="ml-2">{{ $section->grade }}</span>
                                            </td>
                                            <td>
                                                <span class="ml-2">{{ $section->section }}</span>
                                            </td>
                                            <td>
                                                <button data-id="{{ $section->id }}" data-grade="{{ $section->grade }}"
                                                    ...
                                                    type="button" aria-label="Update Student" title="Update section">
    ...
    <script>
        ...
        // Show Edit Modal and fill the form with section data
        function showEditModal(sectionId, grade, section) {
            // Set the form action to the correct route
            editsectionForm.action = `/admin/section/${sectionId}`;
        ...
        function showDeleteModal(sectionId, section) {
            deletesectionForm.action = `/admin/section/${sectionId}`;

            document.getElementById('deleteGrade').innerHTML = section;
            // Show the modal
        ...
        document.querySelectorAll('.edit-btn').forEach((button) => {
            button.addEventListener('click', function () {
                ...
                showEditModal(sectionId, grade, section);
            });
        });
        ...
        document.querySelectorAll('.delete-btn').forEach((button) => {
            button.addEventListener('click', function () {
                const sectionId = this.dataset.id;
                const section = this.dataset.section;
                showDeleteModal(sectionId, section);
            });
        });
    </script>
