  ...
  <div class="flex w-full h-screen">
    ...
    <main class="flex-grow bg-white shadow-lg overflow-x-hidden overflow-y-scroll w-full bg-zinc-50" id="content">
      ...
      <div class="p-5">
        ...
        <!---->
        <div class="bg-white rounded-lg p-1 col-span-2 mt-3 border-t-2 border-teal-700  ">
            ...
            <div class="bg-white col-span-3 lg:col-span-2">
              ...
              <div class="w-full flex justify-end py-3 px-5">
                <button
                  ...
                  id="addAnnouncementPicture"> <i class="fa-solid fa-plus me-1"></i> Add Picture Announcement</button>
              </div>
              <div
                class="bg-white h-96 xl:h-[700px] overflow-x-hidden overflow-y-scroll p-5 shadow-lg"
                id="announcementPicture"></div>
            </div>
