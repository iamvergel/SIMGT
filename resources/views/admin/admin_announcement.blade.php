...
<body class="font-poppins bg-gray-200">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 pb-5">
            ...
            <div class="bg-white col-span-3 lg:col-span-2">
              ...
              <div class="bg-white h-96 xl:h-[700px] shadow-lg border-t-4 border-b-4 border-teal-700"
                ...
                <div class="w-full h-full border-4 border-teal-50 rounded-lg">
                  <div class="table-responsive">
                    <table id="announcementTable" class="display w-">
              ...
              class="absolute inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-[20]">
                <div class="absolute bg-gray-100 rounded-lg shadow-lg p-5">
                  <div class="flex justify-between items-center p-2 px-4 bg-white shadow-l rounded-md">
                  <p class="font-bold text-teal-900">Delete Announcement</p>
                    <span id="closeDeleteModal"
                      class="py-1 px-2 text-[12px] bg-teal-700 hover:bg-teal-800 font-semibold text-white rounded-full float-right"><i
                        class="fas fa-times fa-lg"></i></span>
                  </div>
                  <div class="">
                    <form id="deleteAnnouncementForm" action="{{ route('pictureannouncements.delete', $announcement->id) }}" method="POST" class="mt-5 bg-white p-5 rounded-lg shadow-lg border-2">
                      @csrf
                      @method('DELETE')

                      <p>Are you sure to delete this announcement</p>
                      <div class="mb-4 ">
                        <label for="currentAnnouncement" class="font-semibold text-[15px] mt-4">Current Announcement</label>
                      ...
                      <div class="flex justify-end">
                        ...
                        <button type="submit"
                          class="mt-10 w-1/4 indent-[-2rem] bg-red-700 text-white rounded-lg hover:bg-red-800 transition py-2 text-md font-semibold ">Yes
                        </button>
                      </div>
                    </form>
                  </div>
              ...
              class="absolute inset-0 bg-black bg-opacity-50 hidden flex items-center justify-center z-[20]">
                <div class="absolute bg-gray-100 rounded-lg shadow-lg p-5">
                  ...
                  <div class="">
                    <form id="addAnnouncementForm" action="{{ route('announcementspicture.store') }}" method="POST" enctype="multipart/form-data"
                      class="mt-5 bg-white p-5 rounded-lg shadow-lg border-2">
                      @csrf
                      ...
                      <div class="mb-4">
                        ...
                        <input type="date" id="announcementDate" name="date"
                          class="w-full p-3 border-2 uppercase rounded-md focus:outline-none focus:ring-2 focus:ring-teal-700 text-[15px]" required readonly>
                      ...
                      <div class="mb-4">
                        ...
                        <input type="file" id="announcementImage" name="image"
                          class="w-full p-3 border-2 uppercase rounded-md focus:outline-none focus:ring-2 focus:ring-teal-700 text-[15px]" required>
                        <small id="descriptionHelp" class="text-gray-500">Enter picture (jpeg, png anf jpg) size ()</small>
                      </div>
  ...
  <script>
    ...
    function opendeletemodal(id, date, image) {
        ...
        document.getElementById("deleteAnnouncementForm").action = "/announcements/" + id;
