    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div class="bg-rhombus hidden lg:block">
            ...
            <h3
                ...
                Student Management System <br/> <small class="text-sm font-normal">Beta Testing</small>
            </h3>
                        ...
                        <form class="mt-5" action="{{ route('admin.login') }}" method="POST">
                            ...
                            <div class="loginForm w-80 lg:w-96">
                                ...
                                <div class="mt-8">
                                    ...
                                    <button type="button"
                                        class="bg-sky-700 text-md text-white font-normal px-4 py-2 rounded-full hover:bg-sky-800 w-full mt-2" onclick="window.location.href = '/Admission'">
                                        Admission
                                    </button>
                                </div>
                            </div>
