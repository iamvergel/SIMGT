            ...
            <div class="p-5">
                <div>
                    ...
                    <p class="text-2xl font-bold text-teal-900 ml-5">
                        <span
                            ...
                            class="hover:text-teal-700">My Advisory</span>
                    </p>
                </div>
                <div class="flex justify-between items-center gap-4 mt-10">
                    ...
                    <div class="flex">
                        ...
                        <h1 class="mx-5 font-semibold text-xl text-teal-800" id="section">Grade : {{session('grade') . ' | Section : ' . session('section') }}</h1>
                    </div>
                                                    ...
                                                    <tr class="hover:bg-gray-100">
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="text-white font-medium text-md p-3 text-center inline-flex items-center me-1 bg-blue-700 rounded-full hover:bg-blue-600"
                                                                    type="button" onclick="window.location.href = '{{ route('mystudent.show', ['id' => $student->id]) }}'" title="Show Student Information">
