@php
    ...
    $suffixName = session('admission_sname', '');
                ...
                <div class="grid grid-cols-6 mt-1 border-t-2 border-teal-800">
                                    ...
                                    <div class="block lg:w-96">
                                        ...
                                        <div class="text-center mt-5 text-teal-800 ">
                                            ...
                                            <span class="text-xs tracking-widest font-normal shadow-text-lg mt-0">
                                                ...
                                                {{ session('admission_username') ?? 'Guest' }}</span>
                                            <p class="text-xs">
                                                {{ session('admission_role') ?? 'Guest' }}
                                            </p>
                                        </div>
                                        ...
                                        <form id="avatar-form" method="POST" action="" enctype="multipart/form-data"
                                            ...
                                            <input type="hidden" name="id"
                                                value="{{ Auth::guard('admission')->check() ? Auth::guard('admission')->user()->id : '' }}"
                                                required class="mt-2" />
                    ...
                    <div class="col-span-4 bg-white p-5">
                        ...
                        <div class="table-container h-auto  w-full border-t-2 border-teal-900 " id="password"
                            ...
                            <div class="p-10">
                                <form action="{{ route('admission.changePassword', $user->id) }}" method="POST"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            form.addEventListener('submit', function (event) {
                ...
                fetch('{{ route('admission.update-avatar', [], false) }}', {
