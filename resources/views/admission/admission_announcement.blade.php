...
<body class="font-poppins bg-gray-200">
            ...
            <div class="bg-white col-span-3 lg:col-span-2">
                ...
                <div class="absolute bg-gray-100 rounded-lg shadow-lg px-5 h-96 overflow-y-scroll lg:overflow-hidden lg:h-auto">
                  ...
                  <div class="mb-5">
                    <form id="deleteAnnouncementForm"
                      action="{{ route('pictureannouncementsAdmission.delete', $announcement->id) }}" method="POST"
                      class="mt-5 bg-white p-5 rounded-lg shadow-lg border-2">
                      @csrf
                      @method('DELETE')
              ...
              <div id="addAnnouncementModal"
                ...
                <div class="absolute bg-gray-100 rounded-lg shadow-lg p-5">
                  ...
                  <div class="">
                    <form id="addAnnouncementForm" action="{{ route('admission.announcementspicture.store') }}" method="POST"
              ...
              <div id="updateAnnouncementModal"
                ...
                <div class="absolute bg-gray-100 rounded-lg shadow-lg px-5 overflow-y-scroll lg:overflow-hidden h-1/2 lg:h-auto">
                  ...
                  <div class="mb-5">
                    <form id="updateAnnouncementForm" action="{{ route('admission.announcements.update', '') }}" method="POST"
                      enctype="multipart/form-data" class="mt-5 bg-white p-5 rounded-lg shadow-lg border-2">
                      @csrf
                      @method('POST')
  ...
  <script>
    function openUpdateModal(id, date, image) {
      ...
      document.getElementById("updateAnnouncementForm").action = "/announcements/admission/" + id;
    ...
    function opendeletemodal(id, date, image) {
      ...
      document.getElementById("deleteAnnouncementForm").action = "/StEmelieLearningCenter.HopeSci66/admission/announcement/" + id;
