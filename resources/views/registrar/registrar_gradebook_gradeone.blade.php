            ...
            <div class="p-5">
                <div>
                    ...
                    <p class="text-2xl font-bold text-teal-900 ml-5">
                        <span class="hover:text-teal-700">Grade Book / Class Record / Grade One / {{ $TeacherInfo->first_name }} {{ $TeacherInfo->last_name }}</span> / <span id="subjectName"></span>
                    </p>
                </div>
...
<script>
    ...
    <!-- Drop Student Modal -->
    <div class="fixed hidden inset-0 z-10 bg-black bg-opacity-50  p-5 flex items-center justify-center" id="save-modal">
        <div class="bg-white rounded-sm shadow-lg p-5 max-w-lg mx-auto mt-16">
            <div class="flex justify-center items-center text-6xl text-green-600 py-5">
            <i class="fa-solid fa-floppy-disk"></i>
            </div>
            <div class="flex items-center text-green-9  00 text-lg font-semibold font-normal">
