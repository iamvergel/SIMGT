        ...
        <main class="flex-grow rounded-r-lg bg-white shadow-lg overflow-y-scroll w-full bg-zinc-50" id="content">
            ...
            <div class="p-5">
                ...
                <p class="text-2xl font-bold text-teal-900 ml-5">
                    <span
                        class="hover:text-teal-700">Report Section</span> / Transfer Student
                </p>
                                    ...
                                    @foreach ($students as $student)
                                                ...
                                                @endphp
                                                    ...
                                                    <tr class="hover:bg-gray-100">
                                                        ...
                                                        <td>
                                                            <span class="px-2 py-1 uppercase font-semibold text-[10px] rounded-lg leading-tight text-viole-800 bg-violet-200">
                                                                {{ $student->status }}
                                                            </span>
                                                        </td>
                                                ...
                                                <td class="px-4 py-3 border">
                                                    ...
                                                    <button class="text-white font-medium text-md p-3 text-center inline-flex items-center me-1 bg-blue-700 rounded-full hover:bg-blue-600"
                                                                    type="button" onclick="window.location.href = '{{ route('student.show.transfer.registrar', ['id' => $student->id]) }}'" title="Show Student Information">
