        ...
        <div class="relative px-20 py-10 w-screen h-screen">
            <div class="w-full h-full bg-white rounded-lg shadow overflow-y-scroll">
                <div
                    ...
                    <h3 class="text-lg font-bold text-teal-800 uppercase"><i class="fa-solid fa-users mr-2"></i>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        schoolYearInput.value = "{{ $student->school_year }}";  // Automatically populate school year
        gradeSelect.value = "{{ $student->grade }}";  // Automatically set the grade
