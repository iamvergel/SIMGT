    ...
    <div class="container">
        ...
        <div class="bg-gray">
            <p style="margin-bottom: 1rem;">
                Dear, Teacher {{ $teacher->first_name }} {{ $teacher->last_name }},
            </p>
            <p style="margin-bottom: 1rem;">
                We are pleased to inform you that your account is now active. You can use the following
                credentials to log in:
            </p>
            <p style="margin-bottom: 1rem;">
                <strong>Login Credentials:</strong><br>
                Username (Email):
                {{ strtolower($teacher->last_name) }}{{ strtolower($teacher->first_name) }}@stemilie.edu.ph<br>
                Password: SELC{{ $teacher->last_name }}{{ substr($teacher->teacher_number, -4) }}<br>
            </p>
            <p style="margin-bottom: 1rem;">
