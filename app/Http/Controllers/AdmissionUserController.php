...
class AdmissionUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'admission_number' => 'required|string|unique:admission_user_account,admission_number',
            'username' => 'required|string|unique:admission_user_account,username',
            'password' => 'required',
        ...
        $adminUser = AdmissionUser::create([
    ...
    public function destroy($id)
    {
        ...
        // Return success response
        return back()->with('success', 'Admission user deleted successfully!');
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        $adminUser = AdmissionUser::find($request->id);
        ...
        if ($request->hasFile('avatar')) {
            ...
            $path = $request->file('avatar')->store('admission', 'public');
    ...
    public function showAllAdmin()
    {
        ...
        $admin = AdmissionUser::get();

        // Check if there are no admins
        $noAdmission = $admin->isEmpty() ? "No Admission found" : null;

        return view('admin.admin_admission_user', compact('admin', 'noAdmission'));
    }

    public function changePassword(Request $request, $studentId)
    {
        $student = AdmissionUser::find($studentId);
