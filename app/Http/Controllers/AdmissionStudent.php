...
class AdmissionStudent extends Controller
{
    public function showGradeOneData()
    {
        ...
        return view('admission.admission_student_management_gradeone', compact('students', 'noGradeOneMessage', 'myTeacher', 'studentsPrimary', 'studentsAdditional', 'studentDocuments', 'studentAccount'));
    }
public function showGradeTwoData()
    {
        ...
        // Pass the data to the view
        return view('admission.admission_student_management_gradetwo', compact('students', 'noGradeTwoMessage', 'myTeacher', 'studentsPrimary', 'studentsAdditional', 'studentDocuments', 'studentAccount'));
    ...
    public function showGradeThreeData()
    {
        ...
        // Pass the data to the view
        return view('admission.admission_student_management_gradethree', compact('students', 'noGradeTwoMessage', 'myTeacher', 'studentsPrimary', 'studentsAdditional', 'studentDocuments', 'studentAccount'));
    ...
    public function showGradeFourData()
    {
        ...
        // Pass the data to the view
        return view('admission.admission_student_management_gradefour', compact('students', 'noGradeTwoMessage', 'myTeacher', 'studentsPrimary', 'studentsAdditional', 'studentDocuments', 'studentAccount'));
    ...
    public function showGradeFiveData()
    {
        ...
        // Pass the data to the view
        return view('admission.admission_student_management_gradefive', compact('students', 'noGradeTwoMessage', 'myTeacher', 'studentsPrimary', 'studentsAdditional', 'studentDocuments', 'studentAccount'));
    ...
    public function showGradeSixData()
    {
        ...
        // Pass the data to the view
        return view('admission.admission_student_management_gradesix', compact('students', 'noGradeTwoMessage', 'myTeacher', 'studentsPrimary', 'studentsAdditional', 'studentDocuments', 'studentAccount'));
    }
    ...
    public function showAdmissionInfotmation(Request $request, $id)
    {
        ...
        return view('admission.includes.student_information', compact('students', 'studentsPrimary', 'teachers', 'studentsAdditional', 'studentsPrimaryOne', 'studentDocuments', 'studentAccount', 'finalGradeOne', 'finalGradeTwo', 'finalGradeThree', 'finalGradeFour', 'finalGradeFive', 'finalGradeSix'));
    }
}
