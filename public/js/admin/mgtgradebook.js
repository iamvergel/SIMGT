...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const sectionToogle = document.getElementById('section-toogle');

    sectionToogle.addEventListener('click', () => {
        sectionSidebar.classList.toggle('w-[280px]');
        sectionToogle.classList.toggle('left-[280px]');
        sectionToogle.classList.toggle('top-[0rem]');
        sectionToogle.classList.toggle('rounded-l-none');
    });
});
